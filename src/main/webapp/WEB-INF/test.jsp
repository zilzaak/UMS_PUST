...
<a href="#"><i class="fa  fa-twitter fa-3x"></i> PUSTMC twitter</a>
  ...
  <li class="active" ><a href="#"><i class="fa  fa-phone fa-3x"></i>Contact</a></li>
...
<h1><p style="color:white;">  MEDICAL CENTER OF</p></h1>
...
<div class="col-md">  <button  class="tablinks"  onClick="openCity(event, 'about')"><span class="btn btn-info ">PUST MC</span></button></div>
<div class="col-md"> <button   class="tablinks"  onClick="openCity(event, 'appointment')"><span class="btn btn-info ">APPOINTMENT</span></button></div>
<div class="col-md">  <button  class="tablinks" onClick="openCity(event, 'job')"><span class="btn btn-info ">FIND JOB</span></button></div>
</div>
<!-- Tab content -->
...
<div id="about" class="tabcontent" align="center" >
  <h3>KNOW ABOUT PUST MC</h3>
  <a href="${pageContext.request.contextPath}/choice?operation=aboutus" class="btn btn-success btn-lg">CLICK HERE</a>
  <p >KNOW MORE ABOUT THE PUST MEDICAL CENTER</p>
</div>

<div id="appointment" class="tabcontent" align="center" >
  <h3></h3>
   <a href="${pageContext.request.contextPath}/choice?operation=studentlogin" class="btn btn-primary btn-lg">CLICK HERE</a>
  <p >GET THE APPOINTMENT OF YOUR DOCTOR.</p> 
</div>
<div id="job" class="tabcontent" align="center" >
  <h3>FIND A JOB IN PUST MC </h3>
  <a href="${pageContext.request.contextPath}/choice?operation=findAjob" class="btn btn-primary btn-lg">CLICK HERE</a>
